...
describe('DoublyLinkedList Tests', () => {
  ...
  const unexpectedLists = lists.filter(e => e !== DoublyLinkedList);
  ...
  test('create a DoublyLinkedList', () => {
    expect(list.isInstanceOf(DoublyLinkedList)).toBeTrue();
    ...
    let l = new DoublyLinkedList(values);
    expect(list.isInstanceOf(DoublyLinkedList)).toBeTrue();
    unexpectedLists.forEach(listClass => expect(list.isInstanceOf(listClass)).toBeFalse());
  ...
  test('append a value in DoublyLinkedList', () => {
  ...
  test('prepand a value in DoublyLinkedList', () => {
  ...
  test('insert after a value in DoublyLinkedList', () => {
  ...
  test('insert before a value in DoublyLinkedList', () => {
  ...
  test('find a value in DoublyLinkedList', () => {
  ...
  test('delete a value in DoublyLinkedList', () => {
    list.append(values[1]);
    list.append(values[2]);
  ...
  test('is DoublyLinkedList empty', () => {
  ...
  test('convert the DoublyLinkedList to array', () => {
  ...
  test('reverse the DoublyLinkedList', () => {
    list.reverse();
    expect(list.toArray().toString()).toEqual([values[0]].toString());
