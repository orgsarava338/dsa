...
describe('CircularSinglyLinkedList Tests', () => {
  ...
  const unexpectedLists = lists.filter(e => e !== CircularSinglyLinkedList);

  let list: CircularSinglyLinkedList<T>;

  beforeEach(() => {
    list = new CircularSinglyLinkedList(values[0]);
  });

  test('create a CircularSinglyLinkedList', () => {
    expect(list.isInstanceOf(CircularSinglyLinkedList)).toBeTrue();
    ...
    let l = new CircularSinglyLinkedList(values);
    expect(list.isInstanceOf(CircularSinglyLinkedList)).toBeTrue();
    unexpectedLists.forEach(listClass => expect(list.isInstanceOf(listClass)).toBeFalse());
    ...
    l = new CircularSinglyLinkedList([]);
    expect(list.isInstanceOf(CircularSinglyLinkedList)).toBeTrue();
    unexpectedLists.forEach(listClass => expect(list.isInstanceOf(listClass)).toBeFalse());
  ...
  test('append a value in CircularSinglyLinkedList', () => {
  ...
  test('prepand a value in CircularSinglyLinkedList', () => {
  ...
  test('insert after a value in CircularSinglyLinkedList', () => {
  ...
  test('insert before a value in CircularSinglyLinkedList', () => {
  ...
  test('find a value in CircularSinglyLinkedList', () => {
  ...
  test('delete a value in CircularSinglyLinkedList', () => {
    list.append(values[1]);
    list.append(values[2]);
  ...
  test('get head value in CircularSinglyLinkedList', () => {
    expect(list.getHead()).toBe(values[0]);
    list.prepend(values[1]);
    expect(list.getHead()).toBe(values[1]);
  });

  test('get tail value in CircularSinglyLinkedList', () => {
    expect(list.getTail()).toBe(values[0]);
    list.append(values[1]);
    expect(list.getTail()).toBe(values[1]);
  });

  test('clear the CircularSinglyLinkedList', () => {
  ...
  test('is CircularSinglyLinkedList empty', () => {
  ...
  test('convert the CircularSinglyLinkedList to array', () => {
  ...
  test('reverse the CircularSinglyLinkedList', () => {
    list.reverse();
    expect(list.toArray().toString()).toEqual([values[0]].toString());
